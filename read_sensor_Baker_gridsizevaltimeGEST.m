...
com = CreateSerialConnection('COM6',512000);

InputBufferSize=1000;
total_samples=1000; % the script reads this many samples and then stops.
power=10; % # of powerpins on board
ground=10; % # of groundpins on board
...
while(k<total_samples)
   % disp('in loop for collection')
    ...
    %dlmwrite('140729-10curvelongnotouch.csv', data, '-append');
